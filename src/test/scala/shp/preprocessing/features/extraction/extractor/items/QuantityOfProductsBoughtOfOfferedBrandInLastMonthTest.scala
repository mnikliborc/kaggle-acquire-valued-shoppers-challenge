...
class QuantityOfProductsBoughtOfOfferedBrandInLastMonthTest extends FlatSpec with Matchers with TestData {
  val stream = new CustomersTransactions(fewTransactions)
  val extractor = new QuantityOfBrandPurchaseInXDays(30)
